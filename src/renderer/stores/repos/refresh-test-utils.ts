import type { BranchInfo, BranchSnapshotInfo, PullRequestInfo } from '#/renderer/types.ts'
import {
...
export function branch(name: string, pullRequest?: PullRequestInfo, options: Partial<BranchInfo> = {}): BranchSnapshotInfo {
