...
export const ko: Record<DictKey, string> = {
  ...
  // ---- Workspace picker ----------------------------------------------------
  'workspace-picker.workspaces': '워크스페이스',
  'workspace-picker.close-named': '{name} 닫기',
  ...
  'workspace-picker.clone-title': '리포지토리 클론',
  'workspace-picker.clone-description': '원격 Git 리포지토리를 클론하고 엽니다.',
  ...
  'workspace-picker.clone-path-preview': '{path} 에 클론합니다',
  ...
  'workspace-picker.open-remote-confirm': '원격 작업 공간 열기',
  'workspace-picker.open-remote-diagnostics-title': '연결 테스트',
  'workspace-picker.open-remote-diagnostics-retry': '다시 시도',
  'workspace-picker.open-remote-diagnostics-testing': '연결을 테스트하는 중…',
  'workspace-picker.open-remote-diagnostics-ok': '연결이 정상입니다',
  'workspace-picker.open-remote-diagnostics-stage-ssh': 'SSH 연결 가능',
  'workspace-picker.open-remote-diagnostics-stage-shell': '셸 사용 가능',
  'workspace-picker.open-remote-diagnostics-stage-git': 'Git 설치됨',
  'workspace-picker.open-remote-diagnostics-stage-path': '경로 존재',
  'workspace-picker.open-remote-diagnostics-stage-repo': '유효한 Git 리포지토리',
  'workspace-picker.open-remote-diagnostics-category-auth-failed': '인증 실패',
  'workspace-picker.open-remote-diagnostics-category-host-key': '호스트 키 검증 실패',
  ...
  'workspace-picker.open-remote-diagnostics-category-timeout': '시간 초과',
  'workspace-picker.open-remote-diagnostics-category-cancelled': '취소됨',
  'workspace-picker.open-remote-diagnostics-category-config-changed': 'SSH 설정이 변경됨',
  'workspace-picker.open-remote-diagnostics-category-unknown': '알 수 없는 오류',
  'workspace-picker.open-remote-diagnostics-copy-ssh-command': 'SSH 명령 복사',
  'workspace-picker.open-remote-diagnostics-copy-details': '세부 정보 복사',
  'workspace-picker.open-remote-connect-via-ssh': '시스템 SSH 로 연결',
  ...
  'workspace-picker.open-remote-open-ssh-settings': 'SSH 설정 열기',
  'workspace-picker.open-remote-ssh-config': 'SSH 설정',
  'workspace-picker.open-remote-manual': '수동 입력',
  'workspace-picker.open-remote-no-ssh-hosts': '~/.ssh/config 에서 SSH 호스트를 찾을 수 없음',
  'workspace-picker.open-remote-no-ssh-hosts-help':
    '`Host my-server` 같은 구체적인 Host 블록을 추가한 뒤 이 대화상자를 다시 여세요.',
  'workspace-picker.open-remote-path-preview': '{path} 를 엽니다',
  'workspace-picker.open-remote-path-preview-expanded': '{input} 를 엽니다\n확장 경로: {expanded}',
  'workspace-picker.open-remote-diagnostics-idle-detail': '연결 테스트를 실행해 이 대상을 확인하세요.',
  'workspace-picker.open-remote-private-key-hint':
    '시스템 SSH 를 사용합니다. 키가 ssh-agent 에 추가되었는지 확인하거나 경로를 직접 지정하세요.',
  'workspace-picker.open-remote-port-error': '잘못된 포트',
  'workspace-picker.open-remote-path-required': '경로가 필요합니다',
  'workspace-picker.open-remote-path-absolute': '경로는 / 또는 ~/로 시작해야 합니다',
  ...
  'dashboard.directory.last-modified': '수정 시간',
  ...
  'worktree-state.cherry-pick': '체리픽 진행 중',
  'worktree-state.revert': '되돌리기 진행 중',
  'worktree-state.bisect': '이분 탐색 진행 중',
  'worktree-status.signal.operation': '작업',
  'worktree-status.primary': '기본',
  'worktree-status.linked': '연결됨',
  'worktree-status.changes-loading': '불러오는 중',
  'worktree-status.changes-unavailable': '사용할 수 없음',
  'worktree-status.open-history': '{commit}에서 기록 열기',
  'tab.branches': '브랜치',
  ...
  'branch-status.pr.pending': '불러오는 중',
  'branch-status.pr.unavailable': '사용할 수 없음',
  'branch-status.pr.failed': '불러오지 못함',
  'branch-status.pr.none': '없음',
  ...
  'terminal.file-resolution-progress': '터미널 파일 처리 중',
  ...
  'terminal.composer-file-insertion-rejected': '초안이 변경되어 파일을 삽입하지 않았습니다. 다시 시도하세요.',
  'terminal.paste-file-unsafe': '붙여넣은 경로에 터미널 제어 문자가 있습니다. 파일을 삽입하지 않았습니다.',
  'terminal.paste-file-too-large':
    '파일이 25 MiB 업로드 제한을 초과합니다. 더 작은 파일을 선택하거나 scp 또는 rsync를 사용하세요.',
  'terminal.paste-file-batch-too-large': '선택한 파일이 총 32 MiB 업로드 제한을 초과합니다. 파일 수를 줄이세요.',
  'terminal.paste-file-too-many': '한 번에 최대 256개의 파일을 업로드할 수 있습니다.',
  'terminal.paste-file-overflow': '붙여넣은 경로가 너무 길어 터미널로 보낼 수 없습니다.',
  'terminal.paste-file-remote-unsupported':
    '원격 터미널에는 로컬 파일을 삽입할 수 없습니다. 대신 scp 또는 rsync를 사용하세요.',
  'terminal.composer-label': '터미널 입력기',
  'terminal.composer-open': '터미널 입력기 열기',
  'terminal.composer-close': '접기',
  'terminal.composer-input-placeholder': '터미널로 보내기',
  ...
  'terminal.composer-key-backspace': '백스페이스',
  'terminal.composer-key-tab': 'Tab',
  'terminal.composer-key-arrow-up': '위쪽 화살표 키',
  'terminal.composer-key-arrow-down': '아래쪽 화살표 키',
  ...
  'error.workspace-runtime-settlement-failed':
    '워크스페이스 런타임을 확정하지 못했습니다. 자동 Git 동기화를 중지했습니다. 계속하기 전에 워크스페이스를 다시 열거나 복구하세요.',
