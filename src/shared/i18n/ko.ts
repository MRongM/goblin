...
export const ko: Record<DictKey, string> = {
  ...
  'action.reset-hard': '이전 커밋으로 리셋',
  'action.confirm-reset-hard-title': '이전 커밋으로 리셋하시겠습니까?',
  'action.confirm-reset-hard-body': 'git reset --hard HEAD~1을 실행하여 마지막 커밋의 모든 변경사항을 삭제합니다. 이 작업은 취소할 수 없습니다.',
  'action.confirm-reset-hard-confirm': '리셋',
  ...
  'action.track-remote-branch-creating-title': '원격 브랜치를 로컬로 가져오는 중…',
  ...
  'action.track-remote-branch-title': '원격 브랜치를 로컬로 가져오기',
  ...
  'action.track-remote-branch-confirm': '브랜치 가져오기',
  'action.track-remote-branch-created-title': '로컬 추적 브랜치를 만들었습니다',
