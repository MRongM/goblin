...
export const zh: Record<DictKey, string> = {
  ...
  'menu.file.close-workspace-tab': '关闭工作区标签页',
  'menu.file.close-workspace': '关闭当前工作区',
  'menu.file.settings': '设置…',
  'menu.file.quit': '退出',
  'menu.client-intent-delivery-failed': '应用窗口已发生变化或加载失败，无法发送该操作。请重试。',
  ...
  'dashboard.directory.last-modified': '修改时间',
  ...
  'dashboard.terminals.description': '此工作区中打开了 {count} 个',
  'dashboard.terminals.loading': '正在加载终端...',
  'dashboard.terminals.unavailable': '终端列表暂不可用',
  'dashboard.terminals.open': '打开 {name}',
  'dashboard.terminals.open-failed': '无法打开终端',
  'dashboard.terminals.stale': '正在显示上次已知的终端列表。',
  'dashboard.terminals.error': '错误',
  ...
  'worktree-state.cherry-pick': '正在拣选提交',
  'worktree-state.revert': '正在还原提交',
  'worktree-state.bisect': '正在二分定位',
  'worktree-status.signal.operation': '操作',
  'worktree-status.primary': '主工作树',
  'worktree-status.linked': '链接工作树',
  'worktree-status.changes-loading': '正在加载',
  'worktree-status.changes-unavailable': '不可用',
  'worktree-status.open-history': '打开 {commit} 的历史记录',
  'tab.branches': '分支',
  ...
  'branch-status.pr.pending': '加载中',
  'branch-status.pr.unavailable': '不可用',
  'branch-status.pr.failed': '加载失败',
  'branch-status.pr.none': '无',
  ...
  'terminal.restore-failed': '无法恢复终端',
  ...
  'terminal.file-resolution-progress': '正在处理终端文件',
  ...
  'terminal.taking-over': '正在接管…',
  'terminal.takeover-failed': '无法接管终端。终端可能已关闭，或当前连接尚未准备好，请重试。',
  'terminal.takeover-delivery-uncertain': '连接已中断。重新连接后将刷新终端接管状态。',
  ...
  'terminal.composer-file-insertion-rejected': '草稿已发生变化，文件未插入，请重试。',
  'terminal.paste-file-unsafe': '粘贴路径包含终端控制字符，未插入任何文件。',
  'terminal.paste-file-too-large': '文件超过 25 MiB 上传限制。请选择较小的文件，或使用 scp、rsync。',
  'terminal.paste-file-batch-too-large': '所选文件超过 32 MiB 上传总量限制。请减少文件数量。',
  'terminal.paste-file-too-many': '一次最多上传 256 个文件。',
  'terminal.paste-file-overflow': '粘贴的路径过长，无法发送到终端。',
  'terminal.paste-file-remote-unsupported': '无法向远程终端插入本地文件。请改用 scp 或 rsync。',
  'terminal.composer-label': '终端输入器',
  'terminal.composer-open': '打开终端输入器',
  'terminal.composer-close': '收起',
  'terminal.composer-input-placeholder': '发送到终端',
  ...
  'terminal.composer-key-backspace': '退格',
  'terminal.composer-key-tab': 'Tab',
  'terminal.composer-key-arrow-up': '向上方向键',
  'terminal.composer-key-arrow-down': '向下方向键',
  ...
  'error.trash-file-outcome-uncertain': '无法确认文件是否已移到废纸篓。请先检查文件树，再决定是否重试。',
  'error.clone-outcome-uncertain': '无法确认克隆是否完成。请先检查目标目录，再决定是否重试。',
  'error.external-app-outcome-uncertain': '无法确认外部应用是否已打开。请先检查该应用，再决定是否重试。',
  'error.git-command-cancelled-check-state': 'Git 操作已取消，仓库状态可能已经改变。请检查后再重试。',
  'error.git-command-timeout-check-state': 'Git 操作已超时，仓库状态可能已经改变。请检查后再重试。',
  ...
  'error.workspace-runtime-settlement-failed':
    '工作区运行时无法完成状态结算。已停止自动 Git 同步；继续操作前，请重新打开或修复工作区。',
  ...
  'error.terminal-session-limit-reached': '已达到 1,024 个终端的全局上限。请关闭一个终端后重试。',
  ...
  'settings.web.url': '当前访问地址',
  'settings.web.url-hint': '当前设备访问 Goblin 使用的地址。此地址不一定能被其他设备访问。',
  'settings.web.url-copy': '复制地址',
  'settings.web.url-copied': '地址已复制到剪贴板。',
  'settings.web.url-copy-failed': '无法复制地址。',
  ...
  'settings.web.token-rotated': '新令牌已保存，将在下次重启 Goblin 后生效。',
  'settings.web.token-rotate-failed': '令牌轮换失败。',
  'settings.web.token-rotation-hint': '下方二维码包含当前有效令牌。扫描后会在目标设备上自动填入门页面。',
  ...
  'settings.lan.local-only': '当前仅允许本机访问。',
  'settings.web.qr': '二维码',
  ...
  'settings.global-shortcut-projection-failed': '偏好已保存，但应用快捷键未能更新。请重新打开应用以应用此设置。',
