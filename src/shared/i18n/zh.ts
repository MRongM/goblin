...
export const zh: Record<DictKey, string> = {
  ...
  'action.reset-hard': '重置到上一个提交',
  'action.confirm-reset-hard-title': '重置到上一个提交？',
  'action.confirm-reset-hard-body': '这将执行 git reset --hard HEAD~1，丢弃最后一次提交中的所有更改。此操作无法撤销。',
  'action.confirm-reset-hard-confirm': '重置',
  ...
  'action.create-branch-creating-title': '正在创建分支…',
  'action.create-branch-queued-title': '等待创建分支…',
  ...
  'action.track-remote-branch-confirm': '拉取分支',
  'action.track-remote-branch-created-title': '已创建本地跟踪分支',
