...
export const en = {
  ...
  'action.checkout-to-empty': 'No available branch to switch to.',
  'action.merge': 'Merge',
  ...
  'action.confirm-reset-hard-title': 'Reset to previous commit?',
  'action.confirm-reset-hard-body': 'This will run git reset --hard HEAD~1, discarding all changes in the last commit. This cannot be undone.',
  'action.confirm-reset-hard-confirm': 'Reset',
  ...
  'action.track-remote-branch-exists': 'A local branch with this name already exists.',
  'action.track-remote-branch-confirm': 'Track branch',
  'action.track-remote-branch-created-title': 'Created tracking branch',
