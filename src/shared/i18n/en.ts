...
export const en = {
  ...
  // ---- Workspace picker -----------------------------------------------------
  'workspace-picker.workspaces': 'Workspaces',
  'workspace-picker.close-named': 'Close {name}',
  ...
  'workspace-picker.clone-title': 'Clone repository',
  'workspace-picker.clone-description': 'Clone a remote Git repository and open it.',
  ...
  'workspace-picker.clone-path-preview': 'Will clone into {path}',
  ...
  'workspace-picker.open-remote-confirm': 'Open Remote Workspace',
  'workspace-picker.open-remote-diagnostics-title': 'Connection test',
  'workspace-picker.open-remote-diagnostics-retry': 'Retry',
  'workspace-picker.open-remote-diagnostics-testing': 'Testing connection…',
  'workspace-picker.open-remote-diagnostics-ok': 'Connection looks good',
  'workspace-picker.open-remote-diagnostics-stage-ssh': 'SSH reachable',
  'workspace-picker.open-remote-diagnostics-stage-shell': 'Shell available',
  'workspace-picker.open-remote-diagnostics-stage-git': 'Git installed',
  'workspace-picker.open-remote-diagnostics-stage-path': 'Path exists',
  'workspace-picker.open-remote-diagnostics-stage-repo': 'Git repository valid',
  'workspace-picker.open-remote-diagnostics-category-auth-failed': 'Authentication failed',
  'workspace-picker.open-remote-diagnostics-category-host-key': 'Host key verification failed',
  ...
  'workspace-picker.open-remote-diagnostics-category-timeout': 'Timed out',
  'workspace-picker.open-remote-diagnostics-category-cancelled': 'Cancelled',
  'workspace-picker.open-remote-diagnostics-category-config-changed': 'SSH config changed',
  'workspace-picker.open-remote-diagnostics-category-unknown': 'Unknown error',
  ...
  'workspace-picker.open-remote-open-ssh-settings': 'Open SSH settings',
  'workspace-picker.open-remote-ssh-config': 'SSH Config',
  'workspace-picker.open-remote-manual': 'Manual',
  'workspace-picker.open-remote-no-ssh-hosts': 'No SSH hosts found in ~/.ssh/config',
  'workspace-picker.open-remote-no-ssh-hosts-help':
    'Add a concrete Host block such as `Host my-server` and reopen this dialog.',
  'workspace-picker.open-remote-path-preview': 'Will open {path}',
  'workspace-picker.open-remote-path-preview-expanded': 'Will open {input}\nExpands to {expanded}',
  'workspace-picker.open-remote-diagnostics-idle-detail': 'Run a connection test to verify the target.',
  'workspace-picker.open-remote-private-key-hint':
    'Uses system SSH. Ensure your key is added to ssh-agent or specify the path.',
  'workspace-picker.open-remote-port-error': 'Invalid port',
  'workspace-picker.open-remote-path-required': 'Path required',
  'workspace-picker.open-remote-path-absolute': 'Path must start with / or ~/',
  ...
  'dashboard.directory.last-modified': 'Last modified',
  ...
  'dashboard.remote.local-only': 'local only',
  'dashboard.remote.fetch-failed': 'fetch failed',
  'dashboard.metric.branches': 'Branches',
  'dashboard.metric.branches-detail': '{count} worktree branch(es)',
  'dashboard.metric.worktrees': 'Worktrees',
  'dashboard.metric.worktrees-detail': '{count} dirty',
  'dashboard.metric.sync': 'Sync',
  'dashboard.metric.sync-detail': 'to push / to pull',
  'dashboard.metric.prs': 'PRs',
  'dashboard.metric.prs-detail': 'open linked PRs',
  'dashboard.attention.title': 'Needs attention',
  'dashboard.attention.description': 'Branches with sync, worktree, or check signals to review first.',
  'dashboard.attention.empty': 'No branch needs attention right now.',
  ...
  'worktree-state.cherry-pick': 'Cherry-pick in progress',
  'worktree-state.revert': 'Revert in progress',
  'worktree-state.bisect': 'Bisect in progress',
  'worktree-status.signal.operation': 'Operation',
  'worktree-status.primary': 'primary',
  'worktree-status.linked': 'linked',
  'worktree-status.changes-loading': 'loading',
  'worktree-status.changes-unavailable': 'unavailable',
  'worktree-status.open-history': 'Open history at {commit}',
  ...
  'terminal.confirm-close-running-body': 'Running process:',
  'terminal.confirm-close-running-confirm': 'Close terminal',
  'terminal.progress': 'Terminal progress',
  'terminal.file-resolution-progress': 'Processing terminal files',
  ...
  'terminal.composer-file-insertion-rejected': 'The draft changed, so the file was not inserted. Try again.',
  'terminal.paste-file-unsafe': 'Pasted paths contain terminal control characters. No files were inserted.',
  'terminal.paste-file-too-large': 'File exceeds the 25 MiB upload limit. Choose a smaller file or use scp or rsync.',
  'terminal.paste-file-batch-too-large': 'Selected files exceed the 32 MiB total upload limit. Choose fewer files.',
  'terminal.paste-file-too-many': 'No more than 256 files can be uploaded at once.',
  'terminal.paste-file-overflow': 'Pasted paths are too long for the terminal.',
  'terminal.paste-file-remote-unsupported': 'Files cannot be inserted into remote terminals. Use scp or rsync instead.',
  ...
  'terminal.composer-input-placeholder': 'Send to terminal',
  ...
  'terminal.composer-key-backspace': 'Backspace',
  'terminal.composer-key-tab': 'Tab',
  'terminal.composer-key-arrow-up': 'Arrow up',
  'terminal.composer-key-arrow-down': 'Arrow down',
  ...
  'error.worktree-not-found': 'Worktree not found',
