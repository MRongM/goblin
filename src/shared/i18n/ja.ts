...
export const ja: Record<DictKey, string> = {
  ...
  'action.track-remote-branch-creating-title': 'リモートブランチをローカルに取得中…',
  'action.track-remote-branch-queued-title': 'リモートブランチ取得待機中…',
  ...
  'action.track-remote-branch': 'リモートブランチを取得',
  'action.track-remote-branch-title': 'リモートブランチをローカルに取得',
  ...
  'action.track-remote-branch-confirm': 'ブランチを取得',
  'action.track-remote-branch-created-title': 'ローカル追跡ブランチを作成しました',
