...
export const ja: Record<DictKey, string> = {
  ...
  // ---- Workspace picker ----------------------------------------------------
  'workspace-picker.workspaces': 'ワークスペース',
  'workspace-picker.close-named': '{name} を閉じる',
  ...
  'workspace-picker.clone-title': 'リポジトリをクローン',
  'workspace-picker.clone-description': 'リモート Git リポジトリをクローンして開きます。',
  ...
  'workspace-picker.clone-path-preview': '{path} にクローンします',
  ...
  'workspace-picker.open-remote-confirm': 'リモートワークスペースを開く',
  'workspace-picker.open-remote-diagnostics-title': '接続テスト',
  'workspace-picker.open-remote-diagnostics-retry': '再試行',
  'workspace-picker.open-remote-diagnostics-testing': '接続をテスト中…',
  'workspace-picker.open-remote-diagnostics-ok': '接続は正常です',
  'workspace-picker.open-remote-diagnostics-stage-ssh': 'SSH に接続可能',
  'workspace-picker.open-remote-diagnostics-stage-shell': 'シェル利用可能',
  'workspace-picker.open-remote-diagnostics-stage-git': 'Git インストール済み',
  'workspace-picker.open-remote-diagnostics-stage-path': 'パスが存在する',
  'workspace-picker.open-remote-diagnostics-stage-repo': '有効な Git リポジトリ',
  'workspace-picker.open-remote-diagnostics-category-auth-failed': '認証に失敗しました',
  'workspace-picker.open-remote-diagnostics-category-host-key': 'ホストキーの検証に失敗しました',
  ...
  'workspace-picker.open-remote-diagnostics-category-timeout': 'タイムアウトしました',
  'workspace-picker.open-remote-diagnostics-category-cancelled': 'キャンセルされました',
  'workspace-picker.open-remote-diagnostics-category-config-changed': 'SSH 設定が変更されました',
  'workspace-picker.open-remote-diagnostics-category-unknown': '不明なエラー',
  'workspace-picker.open-remote-diagnostics-copy-ssh-command': 'SSH コマンドをコピー',
  'workspace-picker.open-remote-diagnostics-copy-details': '詳細をコピー',
  'workspace-picker.open-remote-connect-via-ssh': 'システム SSH で接続',
  'workspace-picker.open-remote-config-only-hint':
    'Goblin は ~/.ssh/config に定義された別名からのみ SSH リモートを開きます。',
  ...
  'workspace-picker.open-remote-open-ssh-settings': 'SSH 設定を開く',
  'workspace-picker.open-remote-ssh-config': 'SSH 設定',
  'workspace-picker.open-remote-manual': '手動入力',
  'workspace-picker.open-remote-no-ssh-hosts': '~/.ssh/config に SSH ホストが見つかりません',
  'workspace-picker.open-remote-no-ssh-hosts-help':
    '`Host my-server` のような具体的な Host ブロックを追加してから、このダイアログを開き直してください。',
  'workspace-picker.open-remote-path-preview': '{path} を開きます',
  'workspace-picker.open-remote-path-preview-expanded': '{input} を開きます\n展開後のパス: {expanded}',
  'workspace-picker.open-remote-diagnostics-idle-detail': '接続テストを実行してこのターゲットを確認してください。',
  'workspace-picker.open-remote-private-key-hint':
    'システム SSH を使用します。鍵が ssh-agent に追加されていることを確認するか、鍵のパスを指定してください。',
  'workspace-picker.open-remote-port-error': '無効なポート',
  'workspace-picker.open-remote-path-required': 'パスを入力してください',
  'workspace-picker.open-remote-path-absolute': 'パスは / または ~/ で始まる必要があります',
  ...
  'dashboard.directory.last-modified': '更新日時',
  ...
  'dashboard.remote.local-only': 'ローカルのみ',
  'dashboard.remote.fetch-failed': 'fetch 失敗',
  'dashboard.metric.branches': 'ブランチ',
  'dashboard.metric.branches-detail': '{count} 件の worktree ブランチ',
  'dashboard.metric.worktrees': 'Worktree',
  'dashboard.metric.worktrees-detail': '{count} 件が dirty',
  'dashboard.metric.sync': '同期',
  'dashboard.metric.sync-detail': 'push 待ち / pull 待ち',
  'dashboard.metric.prs': 'PR',
  'dashboard.metric.prs-detail': '開いている関連 PR',
  'dashboard.attention.title': '要確認',
  'dashboard.attention.description': '同期、worktree、チェック状態で先に見るべきブランチ。',
  'dashboard.attention.empty': '今すぐ確認が必要なブランチはありません。',
  ...
  'worktree-state.cherry-pick': 'チェリーピック中',
  'worktree-state.revert': 'リバート中',
  'worktree-state.bisect': '二分探索中',
  'worktree-status.signal.operation': '操作',
  'worktree-status.primary': 'メイン',
  'worktree-status.linked': 'リンク済み',
  'worktree-status.changes-loading': '読み込み中',
  'worktree-status.changes-unavailable': '利用不可',
  'worktree-status.open-history': '{commit} の履歴を開く',
  'tab.branches': 'ブランチ',
  ...
  'branch-status.pr.pending': '読み込み中',
  'branch-status.pr.unavailable': '利用不可',
  'branch-status.pr.failed': '読み込み失敗',
  'branch-status.pr.none': 'なし',
  ...
  'status.no-worktree-body': 'このブランチのワークツリーを作成すると、ここに変更が表示されます。',
  ...
  'terminal.composer-input-placeholder': 'ターミナルへ送信',
  'terminal.composer-more': 'その他の操作',
  'terminal.composer-upload-files': 'アップロード',
  'terminal.composer-copy-content': '内容をコピー',
  'terminal.composer-copy-content-empty': 'コピーできるターミナル内容がありません。',
  'terminal.composer-show-keys': 'ターミナルキーを表示',
  'terminal.composer-show-input': 'テキスト入力を表示',
  'terminal.composer-key-enter': 'Enter',
  'terminal.composer-key-backspace': 'バックスペース',
  'terminal.composer-key-tab': 'Tab',
  'terminal.composer-key-arrow-up': '上矢印キー',
  'terminal.composer-key-arrow-down': '下矢印キー',
