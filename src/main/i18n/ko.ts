...
export const ko: Record<DictKey, string> = {
  ...
  'repo-tabs.add-remote': '원격 SSH 리포지토리 추가',
  ...
  'repo-tabs.remote-opened': '원격 리포지토리를 추가했습니다',
  ...
  // ---- Remote SSH setup -------------------------------------------------
  'remote.add-title': '원격 SSH 리포지토리 추가',
  'remote.add-description': 'SSH 호스트에 남아 있는 Git 리포지토리에 연결합니다.',
  'remote.system-ssh': 'Goblin은 시스템 SSH 설정을 사용하며 키나 비밀번호를 저장하지 않습니다.',
  'remote.ssh-config': 'SSH 설정',
  'remote.enter-manually': '수동 입력',
  'remote.ssh-host': 'SSH 호스트',
  'remote.no-ssh-hosts': 'SSH 호스트를 찾을 수 없음',
  'remote.manual-or-config': '호스트를 수동 입력하거나 SSH 설정에 추가하세요.',
  'remote.host': '호스트',
  'remote.user': '사용자',
  'remote.port': '포트',
  'remote.private-key': '개인 키',
  'remote.choose-private-key': '개인 키 선택',
  'remote.private-key-help': '선택 사항입니다. Goblin은 경로만 저장하고 암호 구문은 ssh-agent 또는 시스템 SSH가 처리합니다.',
  'remote.repository-path': '리포지토리 경로',
  'remote.browse': '찾아보기…',
  'remote.test-connection': '연결 테스트',
  'remote.add-confirm': '리포지토리 추가',
  'remote.port-invalid': '포트는 1에서 65535 사이여야 합니다.',
  'remote.path-required': '원격 절대 경로를 입력하세요.',
  'remote.path-absolute-required': '/srv/goblin 같은 절대 경로를 사용하세요.',
  'remote.picker-title': '원격 리포지토리 선택',
  'remote.picker-blocked': '원격 폴더를 탐색하기 전에 SSH 호스트에 연결하세요.',
  'remote.picker-go': '이동',
  'remote.picker-empty': '디렉터리가 없습니다.',
  'remote.picker-truncated': '처음 200개 디렉터리만 표시합니다.',
  ...
  'remote.ssh-init-title': 'SSH 접근 설정',
  'remote.ssh-init-help': '서버 비밀번호를 한 번 사용해 공개 키를 설치합니다.',
  'remote.ssh-init-password': '임시 서버 비밀번호',
  'remote.ssh-init-button': 'SSH 초기화',
  'remote.ssh-init-working': '초기화 중…',
  'remote.ssh-init-host-key': '호스트 키 확인',
  'remote.ssh-init-trust': '신뢰하고 설치',
  'remote.ssh-init-success': 'SSH 접근이 초기화되었습니다.',
  ...
  'remote-ports.title': '원격 포트',
  'remote-ports.summary': '{running} 실행 중 / {total} 저장됨',
  'remote-ports.scan': '원격 포트 스캔',
  'remote-ports.remote-port': '원격 포트',
  'remote-ports.local-port': '로컬 포트',
  'remote-ports.add': '추가',
  'remote-ports.saved': '저장됨',
  'remote-ports.empty': '전달 중인 포트 없음.',
  'remote-ports.discovered': '발견된 포트',
  'remote-ports.discovered-empty': '발견된 포트 없음.',
  'remote-ports.forward': '전달',
  'remote-ports.start': '시작',
  'remote-ports.stop': '중지',
  'remote-ports.remove': '전달 포트 제거',
  'remote-ports.copy-url': 'URL 복사',
  'remote-ports.copied-url': 'URL 복사됨',
  'remote-ports.open-url': '브라우저에서 열기',
  'remote-ports.mapping': '원격 :{remotePort}',
  'remote-ports.local-target': '127.0.0.1:{localPort}',
  'remote-ports.requested-local': '요청 {port}',
  'remote-ports.unknown-process': '알 수 없는 프로세스',
  'remote-ports.scan-unavailable': '사용 가능한 원격 포트 스캐너가 없습니다.',
  ...
  'error.ssh-host-key-changed': 'SSH 호스트 키가 변경되었습니다. known_hosts를 업데이트하기 전에 서버를 확인하세요.',
  'error.ssh-host-key-scan-failed': 'SSH 호스트 키를 읽을 수 없습니다.',
  'error.ssh-host-key-mismatch': 'SSH 호스트 키 지문이 일치하지 않습니다.',
  'error.ssh-public-key-missing': 'SSH 공개 키가 없습니다.',
  ...
  'error.remote-terminal-unavailable': '선택한 터미널 앱에서는 원격 터미널을 열 수 없습니다',
