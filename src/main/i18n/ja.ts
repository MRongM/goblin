...
export const ja: Record<DictKey, string> = {
  ...
  'repo-tabs.add-remote': 'リモート SSH リポジトリを追加',
  ...
  'repo-tabs.remote-opened': 'リモートリポジトリを追加しました',
  ...
  // ---- Remote SSH setup -------------------------------------------------
  'remote.add-title': 'リモート SSH リポジトリを追加',
  'remote.add-description': 'SSH ホスト上に残る Git リポジトリへ接続します。',
  'remote.system-ssh': 'Goblin はシステム SSH 設定を使い、鍵やパスワードは保存しません。',
  'remote.ssh-config': 'SSH 設定',
  'remote.enter-manually': '手動入力',
  'remote.ssh-host': 'SSH ホスト',
  'remote.no-ssh-hosts': 'SSH ホストが見つかりません',
  'remote.manual-or-config': 'ホストを手動入力するか、SSH 設定に追加してください。',
  'remote.host': 'ホスト',
  'remote.user': 'ユーザー',
  'remote.port': 'ポート',
  'remote.private-key': '秘密鍵',
  'remote.choose-private-key': '秘密鍵を選択',
  'remote.private-key-help': '任意。Goblin はパスのみを保存し、パスフレーズは ssh-agent またはシステム SSH に任せます。',
  'remote.repository-path': 'リポジトリパス',
  'remote.browse': '参照…',
  'remote.test-connection': '接続をテスト',
  'remote.add-confirm': 'リポジトリを追加',
  'remote.port-invalid': 'ポートは 1 から 65535 の範囲で指定してください。',
  'remote.path-required': 'リモートの絶対パスを入力してください。',
  'remote.path-absolute-required': '/srv/goblin のような絶対パスを使ってください。',
  'remote.picker-title': 'リモートリポジトリを選択',
  'remote.picker-blocked': 'リモートフォルダを参照する前に SSH ホストへ接続してください。',
  'remote.picker-go': '移動',
  'remote.picker-empty': 'ディレクトリが見つかりません。',
  'remote.picker-truncated': '最初の 200 ディレクトリを表示しています。',
  ...
  'remote.ssh-init-title': 'SSH アクセス設定',
  'remote.ssh-init-help': 'サーバーパスワードを 1 回だけ使って公開鍵をインストールします。',
  'remote.ssh-init-password': '一時サーバーパスワード',
  'remote.ssh-init-button': 'SSH を初期化',
  'remote.ssh-init-working': '初期化中…',
  'remote.ssh-init-host-key': 'ホスト鍵を確認',
  'remote.ssh-init-trust': '信頼してインストール',
  'remote.ssh-init-success': 'SSH アクセスを初期化しました。',
  ...
  'action.checkout-on-server': 'サーバーでチェックアウト',
  'action.pull': 'プル',
  'action.push': 'プッシュ',
  'action.fetch': 'フェッチ',
  'action.remote': 'リモート',
  ...
  'remote-ports.title': 'リモートポート',
  'remote-ports.summary': '{running} 実行中 / {total} 保存済み',
  'remote-ports.scan': 'リモートポートをスキャン',
  'remote-ports.remote-port': 'リモートポート',
  'remote-ports.local-port': 'ローカルポート',
  'remote-ports.add': '追加',
  'remote-ports.saved': '保存済み',
  'remote-ports.empty': '転送中のポートはありません。',
  'remote-ports.discovered': '検出したポート',
  'remote-ports.discovered-empty': '検出したポートはありません。',
  'remote-ports.forward': '転送',
  'remote-ports.start': '開始',
  'remote-ports.stop': '停止',
  'remote-ports.remove': '転送ポートを削除',
  'remote-ports.copy-url': 'URL をコピー',
  'remote-ports.copied-url': 'URL をコピーしました',
  'remote-ports.open-url': 'ブラウザで開く',
  'remote-ports.mapping': 'リモート :{remotePort}',
  'remote-ports.local-target': '127.0.0.1:{localPort}',
  'remote-ports.requested-local': '要求 {port}',
  'remote-ports.unknown-process': '不明なプロセス',
  'remote-ports.scan-unavailable': '利用可能なリモートポートスキャナーがありません。',
  ...
  'error.ssh-host-key-changed': 'SSH ホスト鍵が変更されています。known_hosts を更新する前にサーバーを確認してください。',
  'error.ssh-host-key-scan-failed': 'SSH ホスト鍵を読み取れませんでした。',
  'error.ssh-host-key-mismatch': 'SSH ホスト鍵のフィンガープリントが一致しません。',
  'error.ssh-public-key-missing': 'SSH 公開鍵がありません。',
  ...
  'error.remote-terminal-unavailable': '選択したターミナルアプリではリモートターミナルを開けません',
