...
export const en = {
  ...
  'repo-tabs.add-remote': 'Add remote SSH repository',
  ...
  'repo-tabs.remote-opened': 'Remote repository added',
  'repo-tabs.missing-title': "Couldn't reopen {n} repository",
  'repo-tabs.missing-dismiss': 'Dismiss',

  // ---- Remote SSH setup --------------------------------------------------
  'remote.add-title': 'Add remote SSH repository',
  'remote.add-description': 'Connect to a Git repository that stays on an SSH host.',
  'remote.system-ssh': 'Goblin uses your system SSH configuration and does not store keys or passwords.',
  'remote.ssh-config': 'SSH config',
  'remote.enter-manually': 'Enter manually',
  'remote.ssh-host': 'SSH host',
  'remote.no-ssh-hosts': 'No SSH hosts found',
  'remote.manual-or-config': 'Enter a host manually or add one to your SSH config.',
  'remote.host': 'Host',
  'remote.user': 'User',
  'remote.port': 'Port',
  'remote.private-key': 'Private key',
  'remote.choose-private-key': 'Choose private key',
  'remote.private-key-help': 'Optional. Goblin stores only the path and uses ssh-agent or system SSH for passphrases.',
  'remote.repository-path': 'Repository path',
  'remote.browse': 'Browse…',
  'remote.test-connection': 'Test connection',
  'remote.add-confirm': 'Add repository',
  'remote.port-invalid': 'Use a port from 1 to 65535.',
  'remote.path-required': 'Enter an absolute remote path.',
  'remote.path-absolute-required': 'Use an absolute path such as /srv/goblin.',
  'remote.picker-title': 'Choose remote repository',
  'remote.picker-blocked': 'Connect to the SSH host before browsing remote folders.',
  'remote.picker-go': 'Go',
  'remote.picker-empty': 'No directories found.',
  'remote.picker-truncated': 'Showing the first 200 directories.',
  ...
  'remote.ssh-init-title': 'SSH access setup',
  'remote.ssh-init-help': 'Uses the server password once to install your public key.',
  'remote.ssh-init-password': 'Temporary server password',
  'remote.ssh-init-button': 'Initialize SSH',
  'remote.ssh-init-working': 'Initializing…',
  'remote.ssh-init-host-key': 'Confirm host key',
  'remote.ssh-init-trust': 'Trust and install',
  ...
  'remote-ports.summary': '{running} running / {total} saved',
  ...
  'remote-ports.copied-url': 'Copied URL',
  ...
  'error.ssh-host-key-changed': 'SSH host key changed. Verify the server before updating known_hosts.',
  'error.ssh-host-key-scan-failed': 'Could not read the SSH host key.',
  'error.ssh-host-key-mismatch': 'SSH host key fingerprint mismatch.',
  'error.ssh-public-key-missing': 'SSH public key is missing.',
