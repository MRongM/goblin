...
export const zh: Record<DictKey, string> = {
  ...
  'repo-tabs.add-remote': '添加远程 SSH 仓库',
  ...
  'repo-tabs.remote-opened': '远程仓库已添加',
  ...
  // ---- Remote SSH setup -------------------------------------------------
  'remote.add-title': '添加远程 SSH 仓库',
  'remote.add-description': '连接仍保留在 SSH 主机上的 Git 仓库。',
  'remote.system-ssh': 'Goblin 使用你的系统 SSH 配置，不存储密钥或密码。',
  'remote.ssh-config': 'SSH 配置',
  'remote.enter-manually': '手动输入',
  'remote.ssh-host': 'SSH 主机',
  'remote.no-ssh-hosts': '未找到 SSH 主机',
  'remote.manual-or-config': '手动输入主机，或把主机加入 SSH 配置。',
  'remote.host': '主机',
  'remote.user': '用户',
  'remote.port': '端口',
  'remote.private-key': '私钥',
  'remote.choose-private-key': '选择私钥',
  'remote.private-key-help': '可选。Goblin 只保存路径，并使用 ssh-agent 或系统 SSH 处理密码短语。',
  'remote.repository-path': '仓库路径',
  'remote.browse': '浏览…',
  'remote.test-connection': '测试连接',
  'remote.add-confirm': '添加仓库',
  'remote.port-invalid': '端口必须在 1 到 65535 之间。',
  'remote.path-required': '请输入远程绝对路径。',
  'remote.path-absolute-required': '使用 /srv/goblin 这样的绝对路径。',
  'remote.picker-title': '选择远程仓库',
  'remote.picker-blocked': '先连接 SSH 主机，再浏览远程文件夹。',
  'remote.picker-go': '前往',
  'remote.picker-empty': '没有找到目录。',
  'remote.picker-truncated': '仅显示前 200 个目录。',
  'remote.loading': '正在加载…',
  ...
  'remote.ssh-init-title': 'SSH 访问初始化',
  'remote.ssh-init-help': '使用一次服务器密码安装你的公钥。',
  'remote.ssh-init-password': '临时服务器密码',
  'remote.ssh-init-button': '初始化 SSH',
  'remote.ssh-init-working': '正在初始化…',
  'remote.ssh-init-host-key': '确认主机密钥',
  'remote.ssh-init-trust': '信任并安装',
  ...
  'remote-ports.remote-port': '远端端口',
  'remote-ports.local-port': '本地端口',
  'remote-ports.add': '添加',
  'remote-ports.saved': '已保存',
  'remote-ports.empty': '没有转发端口。',
  'remote-ports.discovered': '发现的端口',
  'remote-ports.discovered-empty': '没有发现端口。',
  'remote-ports.forward': '转发',
  'remote-ports.start': '启动',
  'remote-ports.stop': '停止',
  'remote-ports.remove': '移除转发端口',
  'remote-ports.copy-url': '复制 URL',
  'remote-ports.copied-url': '已复制 URL',
  'remote-ports.open-url': '在浏览器中打开',
  'remote-ports.mapping': '远端 :{remotePort}',
  'remote-ports.local-target': '127.0.0.1:{localPort}',
  'remote-ports.requested-local': '请求 {port}',
  'remote-ports.unknown-process': '未知进程',
  'remote-ports.scan-unavailable': '远端没有可用的端口扫描工具。',
  ...
  'error.ssh-host-key-changed': 'SSH 主机密钥已变化。更新 known_hosts 前请先确认服务器身份。',
  'error.ssh-host-key-scan-failed': '无法读取 SSH 主机密钥。',
  'error.ssh-host-key-mismatch': 'SSH 主机密钥指纹不匹配。',
  'error.ssh-public-key-missing': '缺少 SSH 公钥。',
